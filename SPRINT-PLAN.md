...
> **Commit:** `c87be36` → `21a9f10` (5 bug fixes + security) | **Production Deployed ✅ 16 ก.พ. 69** | Tag: `v9.2.0`
...
| **Security** | Fix hasPermission() not awaited (MD-5) | [x] ✅ `21a9f10` |
| **Security** | RLS: is_user_active() blocks deactivated writes (MD-7/8) | [x] ✅ SQL migration |
| **Deploy** | merge sit → main (production) | [x] ✅ fast-forward 16 ก.พ. 69 |
...
| BF5 | hasPermission() ไม่ await → Promise bypass permission check | เพิ่ม await ใน UM + app-supabase | `21a9f10` |
